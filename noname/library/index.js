...
export class Library {
	...
	arenaReady = [
		...
		function () {
			_status.skillOwner = {};
			//武将包排序
			let packSort = ["standard", "c309", "shenhua", "yijiang", "refresh", "extra", "sp", "xinghuoliaoyuan", "sp2", "mobile", "tw", "yingbian", "offline", "sb", "clan", "huicui", "shiji", "xianding", "jsrg", "onlyOL", "newjiang", "sixiang", "sxrm"];
